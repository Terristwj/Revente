...
export default {
    ...
    data() {
        return {
            ...
            priceRangeSelected: [this.filter.minPrice, this.filter.maxPrice],
    ...
    methods: {
        ...
        searchPrice() {
            if (this.minPriceInput > this.maxPriceInput) {
                ...
                filters.setPriceRange(this.minPriceInput, this.maxPriceInput);
                this.$emit("update-filter");
            }
        },
        // Reset
                    ...
                    >
                        ...
                        >
                            <div class="form-check">
                                ...
                                />
                                <label
                                    class="form-check-label caps pointing"
                                    :for="gender + isMobile"
                                >
                                    {{ gender }}
                                </label>
